 ...
 * [prefer.yml](prefer.yml)
     * Determines how your purl.obolibrary.org/obo/prefer/ redirects will be handled
     ...
     * Paste in the contents of [prefer.yml](prefer.yml)
 ...
 * [prefer.md](prefer.md)
     ...
     * Paste in the contents of [prefer.md](prefer.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
